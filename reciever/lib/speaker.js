...
var os = require('os');
var debug = require('../node_modules/speaker/node_modules/debug')('speaker');
var binding = require('../node_modules/speaker/node_modules/bindings/bindings.js');
...
binding = binding({ bindings: 'binding', module_root: __dirname + '/../node_modules/speaker/' });
